...
def get_location(question):
    ...
    location = geolocator.geocode(question)
    if location:
        return location.latitude, location.longitude

    else:
        print("question is weather not out side ")
        return None, None
...
latitude, longitude = get_location(question)
...
if latitude and longitude:
    ...
    if response.status_code == 200:
        ...
        print(f"The current weather in {question} is:")
